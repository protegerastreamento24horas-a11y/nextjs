        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700 p-6 shadow-xl">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-purple-400 mb-2">E-mail</h3>
                <p className="text-gray-300">suporte@rifapremiada.com</p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-purple-400 mb-2">Telefone</h3>
                <p className="text-gray-300">(11) 99999-9999</p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-purple-400 mb-2">Horário de Atendimento</h3>
                <p className="text-gray-300">Segunda a Sexta: 9h às 18h</p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-purple-400 mb-2">Endereço</h3>
